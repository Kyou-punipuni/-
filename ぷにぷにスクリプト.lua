...
local startAddress, endAddress = isim({"split_config.arm32_v8a.apk", "libSGF.so"})
...
--スピードMENU toggles--
toggle_baisoku1 = false
toggle_baisoku2 = false
toggle_baisoku3 = false
toggle_baisoku4 = false
...
--無効化MENU toggles--
toggle_kaiwa = false
toggle_mushimegane = false
toggle_fuin = false
toggle_kagi = false
toggle_oshirase = false
toggle_rogubo = false
...
function m6()
    if toggle_resultskip then
        ...
        setHexMemory("libSGF.so", 0x346F708, "C0 69 00 54")
